<template>
    ...
    <div style="width: 100%;">
        ...
        <a-table :row-selection="rowSelection" :row-key="(record)=>record.id" v-loading="tableConfig.loading"
            :pagination="false" class="table" :dataSource="data" :columns="dataFilter(tableConfig.columData)">
            ...
            <template #bodyCell="{ column, record }">
                ...
                <template v-else-if="column.key === 'type'">
                    <span>
                        <a-tag :color="record.type == '1' ? 'volcano' : record.type == '2' ? 'geekblue' : 'green'">
                ...
                <template v-else-if="column.key === 'operation'">
                    <a-row :gutter="[16,16]">
                        <a-col :span="8" v-for="(item, index) in tableConfig.operationData" :key="index">
...
.tools {
    ...
    .columnBox {
        ...
        :deep(.a-checkbox__input.is-checked+.a-checkbox__label) {
            color: #333 !important;
        }
...
@media print {
    ...
    #printMe .a-table__header-wrapper .a-table__header {
        width: 100% !important;
        color: #333 !important;
    ...
    #printMe .a-table__body-wrapper .a-table__body {
        width: 100% !important;
        color: #333 !important;
    }
