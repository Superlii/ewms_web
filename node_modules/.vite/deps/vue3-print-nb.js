...
var e = class {
  ...
  getFormData(e2) {
    ...
    for (let r = 0; r < l.length; r++) {
      ...
      t3.tagName.toLowerCase() === "canvas" ? e3.removeChild(t3) : t3.style.display = "block";
    }
    for (let r = 0; r < i.length; r++) {
      let t3 = i[r], l2 = t3.getAttribute("type"), n = i[r];
      if (l2 || (l2 = t3.tagName === "SELECT" ? "select" : t3.tagName === "TEXTAREA" ? "textarea" : ""), t3.tagName === "INPUT")
        l2 === "radio" || l2 === "checkbox" ? t3.checked && n.setAttribute("checked", t3.checked) : (n.value = t3.value, n.setAttribute("value", t3.value));
      else if (l2 === "select") {
        s++;
...
var t = { directiveName: "print", mounted(t2, i, l) {
  ...
  o = "click", a = () => {
    if (typeof i.value == "string")
      ...
      if (typeof i.value != "object" || !i.value.id)
